<template>
  <div class="grid-center col-12" style="background: #f0ebeb">
    <div class="col-12">
...
＜編集＞…編集を施す部分の総時間（≒演奏時間）に対して、編集費としての料金を計算します。
                ...
                <div class="col-12 youtube-iframe">
                  <div style="position: relative; padding-bottom: 56.25%;">
                    <iframe
                      ...
                      src="https://www.youtube.com/embed/YzUpM0uvlnc"
                      frameborder="0"
                      allow="autoplay;
                      encrypted-media"
                      allowfullscreen>
